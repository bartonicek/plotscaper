...
When I started my PhD, I wanted to make a framework for creating interactive graphics that would support certain types of interaction out of the box. Specifically, I wanted every plot to support linked selection, i.e. the user would be able to click or click and drag some objects in one plot and have all the corresponding cases get highlighted across all other plots. That is, I wanted figures like this: 
